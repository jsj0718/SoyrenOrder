...
//	public SettleFrame settle;
	...
	public void setComponent() {
		...
		totalPanel.setBorder(
				new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(176, 196, 222)));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (completeBt == e.getSource()) {
			...
			if (totalRow != -1) {
				...
				JOptionPane.showConfirmDialog(null, "음료가 완성되었습니다.", "확인", JOptionPane.DEFAULT_OPTION,
						JOptionPane.WARNING_MESSAGE);
			} else {
				JOptionPane.showConfirmDialog(null, "주문을 선택하세요.", "경고", JOptionPane.DEFAULT_OPTION,
						JOptionPane.WARNING_MESSAGE);
			}
